...
public class CurrencyConversionController {
    ...
    @GetMapping("/currency")
    public String displayCurrencyConversion(Model model, @RequestParam(value = "inputMoney",defaultValue = "0") Integer inputMoney, @RequestParam(value = "exchangeRate",defaultValue = "0") Integer exchangeRate) {
